...
public class Park {
	...
	public Park() {
		String parkcode = "unassigned";
		String parkname = "unassigned";
		String state = "unassigned";
		int acreage = 0;
		int elevationinfeet = 0;
		double milesoftrail = 0.0;
		int numberofcampsites = 0;
		String climate = "unassigned";
		int yearfounded = 0;
		int annualvisitorcount = 0;
		String inspirationalquote = "unassigned";
		String inspirationalquotesource = "unassigned";
		String parkdescription = "unassigned";
		int entryfee = 0;
		int numberofanimalspecies = 0;
	}
